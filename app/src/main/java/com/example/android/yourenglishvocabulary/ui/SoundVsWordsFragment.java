 ...
 * {@link SoundVsWordsFragment.OnSoundVsImagesFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link SoundVsWordsFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SoundVsWordsFragment extends Fragment {

    private static final String TAG = "SoundVsWordsFragment";
     ...
     *
     * @return A new instance of fragment SoundVsWordsFragment.
     */
    public static SoundVsWordsFragment newInstance(String word, String option1, String option2,
                                                   String option3, String rightWord) {
        SoundVsWordsFragment fragment = new SoundVsWordsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_sound_vs_words, container, false);
    ...
    public void onAttachToParentFragment(Fragment parentFragment) {
        if (parentFragment instanceof SoundVsWordsFragment.OnSoundVsImagesFragmentInteractionListener) {
            mListener = (SoundVsWordsFragment.OnSoundVsImagesFragmentInteractionListener) parentFragment;
        } else {
