 ...
 * {@link ImageVsWordsFragment.OnImageVsWordsFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link ImageVsWordsFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ImageVsWordsFragment extends Fragment {

    private static final String TAG = "ImageVsWordsFragment";
    ...
    private OnImageVsWordsFragmentInteractionListener mListener;
     ...
     *
     * @return A new instance of fragment ImageVsWordsFragment.
     */
    public static ImageVsWordsFragment newInstance(String word, String option1, String option2,
                                                   String option3, String rightWord) {
        ImageVsWordsFragment fragment = new ImageVsWordsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_image_vs_words, container, false);
        ...
        wordImageView.setImageBitmap(ImageReader.readImageFromFile(getContext(), mWord));
    ...
    public void nextQuestion(View view) {
        if (mListener != null) {
            mListener.onImageVsWordsFragmentInteraction(view);
        }
    }

    public void onAttachToParentFragment(Fragment parentFragment) {
        if (parentFragment instanceof ImageVsWordsFragment.OnImageVsWordsFragmentInteractionListener) {
            mListener = (ImageVsWordsFragment.OnImageVsWordsFragmentInteractionListener) parentFragment;
        } else {
     ...
     */
    public interface OnImageVsWordsFragmentInteractionListener {
        void onImageVsWordsFragmentInteraction(View view);
    }
}
